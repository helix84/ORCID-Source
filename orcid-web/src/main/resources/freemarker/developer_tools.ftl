					...
					<div class="sso-api" ng-controller="SSOPreferencesCtrl">						
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<p><i><@orcid.msg 'developer_tools.note' /> <a href="./my-orcid" target="_blank"><@orcid.msg 'developer_tools.note.link.text' /></a><@orcid.msg 'developer_tools.note.link.point' /></i></p>
								...
								<div class="centered bottomBuffer">
									...
									<#else>
										<button class="btn btn-primary" ng-click="verifyEmail()" ><@orcid.msg 'developer_tools.public_member.verify.link' /></button>
									</#if>
								</div>
